...
const char* LocalizationManager::keyFor(TextId id) {
    switch (id) {
        ...
        case TextId::ToastNoNews: return "TOAST_NO_NEWS";
        case TextId::ToastRequestInProgress: return "TOAST_REQUEST_IN_PROGRESS";
        case TextId::ToastCouldNotStartRequest: return "TOAST_COULD_NOT_START_REQUEST";
        case TextId::ToastSendingRequest: return "TOAST_SENDING_REQUEST";
        case TextId::ToastRequestSent: return "TOAST_REQUEST_SENT";
        case TextId::ToastRequestFailed: return "TOAST_REQUEST_FAILED";
        case TextId::ToastReportSent: return "TOAST_REPORT_SENT";
        case TextId::ToastReportFailed: return "TOAST_REPORT_FAILED";
        case TextId::ToastReportFailedStart: return "TOAST_REPORT_FAILED_START";
        case TextId::ToastUpdateThreadFailed: return "TOAST_UPDATE_THREAD_FAILED";
        case TextId::ToastCheckingUpdates: return "TOAST_CHECKING_UPDATES";
        case TextId::ToastUpdateAvailablePrefix: return "TOAST_UPDATE_AVAILABLE_PREFIX";
        case TextId::ToastUpdateAvailableSuffix: return "TOAST_UPDATE_AVAILABLE_SUFFIX";
        case TextId::ToastUpToDatePrefix: return "TOAST_UP_TO_DATE_PREFIX";
        case TextId::ToastUpToDateSuffix: return "TOAST_UP_TO_DATE_SUFFIX";
        case TextId::ToastPleaseWait: return "TOAST_PLEASE_WAIT";
        case TextId::ToastWaitOperation: return "TOAST_WAIT_OPERATION";
        case TextId::ToastNothingToInstall: return "TOAST_NOTHING_TO_INSTALL";
        case TextId::ToastInstallUnavailable: return "TOAST_INSTALL_UNAVAILABLE";
        case TextId::ToastCouldNotStartInstall: return "TOAST_COULD_NOT_START_INSTALL";
        case TextId::ToastInstallAllStopped: return "TOAST_INSTALL_ALL_STOPPED";
        case TextId::NewsTitle: return "NEWS_TITLE";
        case TextId::DataRequestTitle: return "DATA_REQUEST_TITLE";
        case TextId::DataRequestBody1: return "DATA_REQUEST_BODY_1";
        case TextId::DataRequestBody2: return "DATA_REQUEST_BODY_2";
        case TextId::DataRequestBody3: return "DATA_REQUEST_BODY_3";
        case TextId::DataRequestBody4: return "DATA_REQUEST_BODY_4";
        case TextId::DataRequestSend: return "DATA_REQUEST_SEND";
        case TextId::FilterActiveLabel: return "FILTER_ACTIVE_LABEL";
        case TextId::FilterClearHint: return "FILTER_CLEAR_HINT";
        case TextId::UnknownAuthor: return "UNKNOWN_AUTHOR";
        case TextId::LoadingCatalogFallback: return "LOADING_CATALOG_FALLBACK";
        case TextId::PreparingFallback: return "PREPARING_FALLBACK";
        case TextId::PleaseWaitFallback: return "PLEASE_WAIT_FALLBACK";
        case TextId::LoadingCatalogLocalCache: return "LOADING_CATALOG_LOCAL_CACHE";
        case TextId::LoadingHomebrewCatalogMsg: return "LOADING_HOMEBREW_CATALOG_MSG";
        case TextId::CheckingCatalogCache: return "CHECKING_CATALOG_CACHE";
        case TextId::CheckingCatalogOfflineOk: return "CHECKING_CATALOG_OFFLINE_OK";
        case TextId::CatalogReadyMsg: return "CATALOG_READY_MSG";
        case TextId::CatalogUnavailableMsg: return "CATALOG_UNAVAILABLE_MSG";
        case TextId::UnableToLoadCatalog: return "UNABLE_TO_LOAD_CATALOG";
        case TextId::UnableToStartCatalogCheck: return "UNABLE_TO_START_CATALOG_CHECK";
        case TextId::CatalogsReadyMsg: return "CATALOGS_READY_MSG";
        case TextId::StartupPhaseLabel: return "STARTUP_PHASE_LABEL";
        case TextId::StartupUpdateLabel: return "STARTUP_UPDATE_LABEL";
        case TextId::CheckingForAppUpdates: return "CHECKING_FOR_APP_UPDATES";
        case TextId::SelfUpdateLabel: return "SELF_UPDATE_LABEL";
        case TextId::StartingUpdaterMsg: return "STARTING_UPDATER_MSG";
        case TextId::UpdatingApplicationMsg: return "UPDATING_APPLICATION";
        case TextId::UpdateStartupUnavailable: return "UPDATE_STARTUP_UNAVAILABLE";
        case TextId::UpdateUnavailableContinue: return "UPDATE_UNAVAILABLE_CONTINUE";
        case TextId::LabelAppVpk: return "LABEL_APP_VPK";
        case TextId::SelfUpdateStage: return "SELF_UPDATE_STAGE";
        case TextId::SelfUpdateStarting: return "SELF_UPDATE_STARTING";
        case TextId::SelfUpdateThreadFailed: return "SELF_UPDATE_THREAD_FAILED";
        case TextId::ToastLockedCircleOnly: return "TOAST_LOCKED_CIRCLE_ONLY";
        case TextId::ToastFiltersCleared: return "TOAST_FILTERS_CLEARED";
        case TextId::InstMsgReady: return "INST_MSG_READY";
        case TextId::InstMsgStopped: return "INST_MSG_STOPPED";
        case TextId::InstMsgDownloading: return "INST_MSG_DOWNLOADING";
        case TextId::InstMsgStartingDownload: return "INST_MSG_STARTING_DOWNLOAD";
        case TextId::InstMsgCancellingDownload: return "INST_MSG_CANCELLING_DOWNLOAD";
        case TextId::InstMsgNoInternet: return "INST_MSG_NO_INTERNET";
        case TextId::InstMsgNotEnoughSpace: return "INST_MSG_NOT_ENOUGH_SPACE";
        case TextId::InstMsgPreparingLicense: return "INST_MSG_PREPARING_LICENSE";
        case TextId::InstMsgQueuingBgdl: return "INST_MSG_QUEUING_BGDL";
        case TextId::InstMsgCouldNotCreateJob: return "INST_MSG_COULD_NOT_CREATE_JOB";
        case TextId::InstMsgCouldNotCreateThread: return "INST_MSG_COULD_NOT_CREATE_THREAD";
        case TextId::InstMsgCouldNotStartThread: return "INST_MSG_COULD_NOT_START_THREAD";
        case TextId::InstMsgDownloadCancelled: return "INST_MSG_DOWNLOAD_CANCELLED";
        case TextId::InstMsgDownloadFailed: return "INST_MSG_DOWNLOAD_FAILED";
        case TextId::InstMsgFinalizingStorage: return "INST_MSG_FINALIZING_STORAGE";
        case TextId::InstMsgPreparingInstall: return "INST_MSG_PREPARING_INSTALL";
        case TextId::InstMsgInstallingPlugin: return "INST_MSG_INSTALLING_PLUGIN";
        case TextId::InstMsgCannotCreatePluginDir: return "INST_MSG_CANNOT_CREATE_PLUGIN_DIR";
        case TextId::InstMsgCannotOpenPlugin: return "INST_MSG_CANNOT_OPEN_PLUGIN";
        case TextId::InstMsgCannotWritePlugin: return "INST_MSG_CANNOT_WRITE_PLUGIN";
        case TextId::InstMsgPluginCopyRead: return "INST_MSG_PLUGIN_COPY_READ";
        case TextId::InstMsgPluginCopyWrite: return "INST_MSG_PLUGIN_COPY_WRITE";
        case TextId::InstMsgPluginInstalled: return "INST_MSG_PLUGIN_INSTALLED";
        case TextId::InstMsgRetryIncomplete: return "INST_MSG_RETRY_INCOMPLETE";
        case TextId::InstMsgRetryGeneric: return "INST_MSG_RETRY_GENERIC";
        case TextId::InstMsgRetryDownload: return "INST_MSG_RETRY_DOWNLOAD";
        case TextId::InstMsgInstalledAt: return "INST_MSG_INSTALLED_AT";
        case TextId::InstMsgInstallComplete: return "INST_MSG_INSTALL_COMPLETE";
        case TextId::InstMsgZipExtractedTo: return "INST_MSG_ZIP_EXTRACTED_TO";
        case TextId::InstMsgInstalledRefreshHint: return "INST_MSG_INSTALLED_REFRESH_HINT";
        case TextId::InstMsgQueuedBgdl: return "INST_MSG_QUEUED_BGDL";
        case TextId::InstMsgBgdlLicenseFailed: return "INST_MSG_BGDL_LICENSE_FAILED";
        case TextId::InstMsgPromoteFailed: return "INST_MSG_PROMOTE_FAILED";
        case TextId::InstMsgPromoterTimeout: return "INST_MSG_PROMOTER_TIMEOUT";
        case TextId::InstMsgCancelled: return "INST_MSG_CANCELLED";
        case TextId::InstMsgExtractCancelled: return "INST_MSG_EXTRACT_CANCELLED";
        case TextId::InstMsgExtractFailed: return "INST_MSG_EXTRACT_FAILED";
        case TextId::InstMsgPackagePrepFailed: return "INST_MSG_PACKAGE_PREP_FAILED";
        case TextId::InstMsgInvalidVpkLayout: return "INST_MSG_INVALID_VPK_LAYOUT";
        case TextId::InstMsgVpkNotFound: return "INST_MSG_VPK_NOT_FOUND";
        case TextId::InstMsgEmptyPath: return "INST_MSG_EMPTY_PATH";
        case TextId::InstMsgFileNotFound: return "INST_MSG_FILE_NOT_FOUND";
        case TextId::InstMsgUnsupportedFormat: return "INST_MSG_UNSUPPORTED_FORMAT";
        case TextId::InstMsgCannotCreateDir: return "INST_MSG_CANNOT_CREATE_DIR";
        case TextId::InstMsgCannotOpenSource: return "INST_MSG_CANNOT_OPEN_SOURCE";
        case TextId::InstMsgCannotOpenDest: return "INST_MSG_CANNOT_OPEN_DEST";
        case TextId::InstMsgReadFailed: return "INST_MSG_READ_FAILED";
        case TextId::InstMsgWriteFailed: return "INST_MSG_WRITE_FAILED";
        case TextId::InstMsgNotPbp: return "INST_MSG_NOT_PBP";
        case TextId::InstMsgNotIsoCso: return "INST_MSG_NOT_ISO_CSO";
        case TextId::InstMsgNotPkg: return "INST_MSG_NOT_PKG";
        case TextId::InstMsgPkgNotFound: return "INST_MSG_PKG_NOT_FOUND";
        case TextId::InstMsgRifNotFound: return "INST_MSG_RIF_NOT_FOUND";
        case TextId::InstMsgInstallationFailed: return "INST_MSG_INSTALLATION_FAILED";
        case TextId::StageRetrying: return "STAGE_RETRYING";
        case TextId::StageNetwork: return "STAGE_NETWORK";
        case TextId::StageSpace: return "STAGE_SPACE";
        case TextId::StagePlugin: return "STAGE_PLUGIN";
        case TextId::StageCompleted: return "STAGE_COMPLETED";
